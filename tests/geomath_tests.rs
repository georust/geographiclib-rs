...
//         println!("test_ang_diff_vs_cpp result.{} abs {:e} at line {}, rel {:e} at line {}, sign-change {}", i, entry.diff_abs, entry.DeltaEntry, entry.diff_rel, entry.line_rel, entry.sign_change);
//     });
// }
...
//     delta_entries.lock().unwrap().iter().enumerate().for_each(|(i, entry)| {
//         println!("test_ang_normalize_vs_cpp result.{} abs {:e} at line {}, rel {:e} at line {}, sign-change {}", i, entry.diff_abs, entry.DeltaEntry, entry.diff_rel, entry.line_rel, entry.sign_change);
//     });
// }
...
//     delta_entries.lock().unwrap().iter().enumerate().for_each(|(i, entry)| {
//         println!("test_atan2d_vs_cpp result.{} abs {:e} at line {}, rel {:e} at line {}, sign-change {}", i, entry.diff_abs, entry.DeltaEntry, entry.diff_rel, entry.line_rel, entry.sign_change);
//     });
// }
...
//         entries[].add(items[1], result.0, line_num, &mut entries[0]);
//         // todo: try to reduce allowed difference to 0.0
//         // todo: try to pass allow_sign_change=false
//         assert_delta!(items[1], result.0, 2e-16, true, "sinx-out (result.0)", line_num);

//         entries[].add(items[2], result.1, line_num, &mut entries[1]);
//         // todo: try to reduce allowed difference to 0.0
//         // todo: try to pass allow_sign_change=false
...
//     delta_entries.lock().unwrap().iter().enumerate().for_each(|(i, entry)| {
//         println!("test_sincosd_vs_cpp result.{} abs {:e} at line {}, rel {:e} at line {}, sign-change {}", i, entry.diff_abs, entry.DeltaEntry, entry.diff_rel, entry.line_rel, entry.sign_change);
//     });
// }
...
//         entries[].add(items[2], result, line_num, &mut entries[0]);
//         // todo: try to reduce allowed difference to 0.0
//         // todo: try to pass allow_sign_change=false
...
//     delta_entries.lock().unwrap().iter().enumerate().for_each(|(i, entry)| {
//         println!("test_astroid_vs_cpp result.{} abs {:e} at line {}, rel {:e} at line {}, sign-change {}", i, entry.diff_abs, entry.DeltaEntry, entry.diff_rel, entry.line_rel, entry.sign_change);
//     });
// }
