...
mod tests {
    ...
    fn test_lengths() {
        ...
        assert_eq!(
            ...
            (
                std::f64::NAN,
                0.024679842274314294,
                0.0016717180169067588,
                std::f64::NAN,
                std::f64::NAN
            )
        );
