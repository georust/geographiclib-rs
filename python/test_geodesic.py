...
from geodesic import Geodesic, Math
...
class GeodesicTest(unittest.TestCase):
    ...
    def test_inverse(self):
        for l in GeodesicTest.testcases:
            (lat1, lon1, azi1, lat2, lon2, azi2, s12, a12, m12, M12, M21, S12) = l
            inv = Geodesic.WGS84.Inverse(
                lat1, lon1, lat2, lon2, Geodesic.ALL | Geodesic.LONG_UNROLL
            )
    ...
    def test_direct(self):
        for l in GeodesicTest.testcases:
            (lat1, lon1, azi1, lat2, lon2, azi2, s12, a12, m12, M12, M21, S12) = l
            dir = Geodesic.WGS84.Direct(
                lat1, lon1, azi1, s12, Geodesic.ALL | Geodesic.LONG_UNROLL
            )
    ...
    def test_arcdirect(self):
        for l in GeodesicTest.testcases:
            (lat1, lon1, azi1, lat2, lon2, azi2, s12, a12, m12, M12, M21, S12) = l
            dir = Geodesic.WGS84.ArcDirect(
                lat1, lon1, azi1, a12, Geodesic.ALL | Geodesic.LONG_UNROLL
            )
            self.assertAlmostEqual(lat2, dir["lat2"], delta=1e-13)
            self.assertAlmostEqual(lon2, dir["lon2"], delta=1e-13)
            self.assertAlmostEqual(azi2, dir["azi2"], delta=1e-13)
...
class GeodSolveTest(unittest.TestCase):
    ...
    def test_GeodSolve4(self):
        ...
        inv = Geodesic.WGS84.Inverse(36.493349428792, 0, 36.49334942879201, 0.0000008)
    ...
    def test_GeodSolve17(self):
        ...
        dir = Geodesic.WGS84.Direct(
            40, -75, -10, 2e7, Geodesic.STANDARD | Geodesic.LONG_UNROLL
        )
    ...
    def test_GeodSolve29(self):
        ...
        dir = Geodesic.WGS84.Inverse(
            0, 539, 0, 181, Geodesic.STANDARD | Geodesic.LONG_UNROLL
        )
    ...
    def test_GeodSolve61(self):
        ...
        dir = Geodesic.WGS84.Direct(
            45, 0, -0.000000000000000003, 1e7, Geodesic.STANDARD | Geodesic.LONG_UNROLL
        )
    ...
    def test_GeodSolve65(self):
        ...
        line = Geodesic.WGS84.InverseLine(
            30, -0.000000000000000001, -31, 180, Geodesic.ALL
        )
    ...
    def test_GeodSolve66(self):
        ...
        self.assertAlmostEqual(dir["lon2"], -180.00000, delta=0.5e-5)
        self.assertAlmostEqual(dir["azi2"], -0.00000, delta=0.5e-5)
        dir = line.Position(0.5 * line.s13, Geodesic.STANDARD | Geodesic.LONG_UNROLL)
    ...
    def test_GeodSolve74(self):
        ...
        # 2015-10-16.
        inv = Geodesic.WGS84.Inverse(54.1589, 15.3872, 54.1591, 15.3877, Geodesic.ALL)
